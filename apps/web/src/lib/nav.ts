...
export const NAV_GROUPS: readonly NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "API tokens", href: "/settings/api-tokens", icon: KeyRound, permission: "settings" },
      { label: "Infrastructure", href: "/settings/infrastructure", icon: Server, permission: "settings" },

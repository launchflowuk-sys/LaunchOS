...
export const WORK: readonly WorkItem[] = [
  ...
  },
  {
    ...
    sector: "Beauty salon",
    url: "https://booking.begorgeousbymonika.com",
  ...
  },
  {
    ...
    url: "https://www.thurrocktuitionacademy.co.uk",
    ...
    brief: {
      ...
      results: "Built and moving onto our servers as the first of our Replit migrations — the lowest-risk one, so the pipeline is proven before the bigger sites follow.",
    },
  ...
  },
  {
    ...
    brief: {
      ...
      results: "In TestFlight with the shop. Customer and staff share one app, role-switched, alongside an owner dashboard.",
    },
  ...
  },
  {
    ...
    url: null,
    summary: "Ten weeks of competitor and search research, and a build plan that positions the firm where nobody else is.",
    brief: {

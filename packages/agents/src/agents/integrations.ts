 ...
 * Support Triage agent's approval-gated tools. Plan 5 widens this further as
 * the payments and ad-sentinel agents land.
 */
export type AgentIntegrations = Pick<Integrations, "uptime" | "hosting" | "dns" | "cms">;

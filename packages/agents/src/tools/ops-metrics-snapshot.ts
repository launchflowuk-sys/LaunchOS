...
export const opsMetricsSnapshotTool = defineTool({
  ...
  description:
    ...
    "(in pence), content published/failed, agent runs and failures, hours the team clocked, client reviews nobody has answered " +
    "for over five days, and which clients are over or near the monthly allowances of the package they pay for. Quote only figures from this.",
  input: Input,
  risk: "safe",

...
export const PORTFOLIO_CLIENTS: readonly CaseStudySeed[] = [
  ...
  },
  {
    slug: "ama-facilities",
    name: "AMA Facilities",
    clientName: "AMA Facilities Limited",
    sector: "Commercial cleaning and facilities support",
    summary: "A contract cleaning site built to be shortlisted: every service on its own page, and the specification a facilities manager needs before they will ask for a price.",
    brief: {
    ...
    stack: ["WordPress", "Divi", "Google Business Profile"],
    year: 2026,
    url: "https://amafacilities.co.uk",
    screenshots: { desktop: "/work/ama-facilities-desktop.jpg", mobile: "/work/ama-facilities-mobile.jpg" },
    featured: false,
    kind: "client",
    deliveryStatus: "live",
    charity: false,
